 ...
 */
extern class Authom extends EventEmitter
{
	/**
	 ...
	 * @param	p_options
	 */
	@:overload(function(p_options:AuthomServerOption):EventEmitter{})
	function createServer(p_options : AuthomServerOption, p_callback : IncomingMessage -> ServerResponse -> Void) : EventEmitter;
	 ...
	 * @param	p_server
	 */
	@:overload(function(p_server:HTTPS):Void { } )	
	function listen(p_server : HTTP):Void;
